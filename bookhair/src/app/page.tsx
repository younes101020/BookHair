...
export default function Home() {
  return (
    <div>
      <main className="flex h-screen w-full flex-wrap items-center justify-center bg-black bg-gray-400">
        ...
        <svg
          id="wave"
          className="absolute bottom-0 left-0 rotate-0 transform transition duration-300"
